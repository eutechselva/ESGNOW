...
import { deleteErrorQueue, getErrorQueue } from "@ums-service";
...
export const ErrorQueue: React.FunctionComponent<QueueComponentProps> = (props) => {
    ...
    const getData = useCallback(async() => {
        const { data, error } = await getErrorQueue(uxpContext)
                ...
                title: <div className='title-container'>
                    ...
                    <Button 
                        ...
                        onClick={async() => {
                            try {
                                setIsLoading(true)
                                await deleteErrorQueue(uxpContext)
                            } finally {
                                setIsLoading(false)
                            }
                        }} 
