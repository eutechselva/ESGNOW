...
import { getPendingQueueForChanges } from "@ums-service";
import { CRUDComponent, Modal, WidgetWrapper } from 'uxp/components'
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";

interface QueueComponentProps extends BaseWidgetProps {}

export const PendingQueue: React.FunctionComponent<QueueComponentProps> = (props) => {
    ...
    const getData = useCallback(async() => {
        const { data, error } = await getPendingQueueForChanges(uxpContext)
